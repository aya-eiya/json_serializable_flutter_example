...
This example is copied from https://github.com/google/json_serializable.dart as a flutter application project.
...
_NOTE_: If you're using Flutter, replace `pub run` with `flutter packages pub run`.
